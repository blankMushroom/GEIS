...
This is the readme for GEIS, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. GEIS) > Ok.
...
- To run the project find GEIS.java (which will be in under src/main/java/com/blankmushroom) and right click > Run 'GEIS'
